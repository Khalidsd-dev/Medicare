...
?>
  <div class="session">
    <div class="left">
      <!-- The SVG code for the left side of the login page, which includes a logo or graphic representation related to the healthcare theme. -->
    ...
    <form action="DatabaseManager.php" method="POST" class="log-in" autocomplete="off"> 
...
<rect class="st0" width="100" height="100"/>
      ...
      <a href="../index.html" class="discrete">Back To Home</a>
    </form>
  </div>
</body>
</html>
